...
<CardGrid>
	...
	<Card title="Number three" icon="list-format">
		This card also contains some content.
	</Card>
	<Card title="Jigsaw pieces" icon="puzzle">
...
<LinkButton href="/reference/configuration/" variant="minimal" icon="external">
	Learn more
</LinkButton>
